...
class Move {
    ...
    public String toString() {
        if (_fromIndex == -1 && -1 == _toIndex) {
            return "-";
        }
        String c0 = String.valueOf(_col0);
        String r0 = String.valueOf(_row0);
        String c1 = String.valueOf(_col1);
        String r1 = String.valueOf(_row1);
        return c0 + r0 + "-" + c1 + r1;
    }
